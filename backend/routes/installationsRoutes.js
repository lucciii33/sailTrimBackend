...
// Repos removed inside Olivia, and reconnecting one of them.
router.get("/removed", protect, listRemovedRepos);
router.post("/:installationId/repos/:repo/restore", protect, restoreRepo);
