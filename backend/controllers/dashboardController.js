...
async function generateTestQuestions(req, res) {
    ...
    const prompt = `Generate test questions for the topic ${topic}. Add "@" at the start of each completion question, "-" at the start of each true/false question, "$" at the start of each multiple choice question, and "^" at the start of each short answer question.`;
