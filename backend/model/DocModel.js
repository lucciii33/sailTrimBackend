...
const docSchema = new mongoose.Schema({
  ...
  // Set by the watcher when a merge changes this endpoint's contract — a param
  // added, removed or retyped, or a response code added or removed. The doc
  // text itself is regenerated by the backfill; this records WHEN and in which
  // PR, so "Edited · last at <date>" can be shown next to it. Overwritten on
  // every later edit, so it always reflects the most recent change.
